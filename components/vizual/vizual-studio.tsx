          ...
          >
            ...
            >
              ...
              <div className="p-4">
                ...
                <button onClick={handleTryNow} className="w-full py-2 rounded-lg bg-white text-black font-bold hover:bg-gray-200 transition-all">
          ...
          >
            ...
            >
              ...
              <div className="p-6 pt-2">
                <h3 className={`text-xl font-bold mb-2 text-white ${spaceGrotesk.className}`}>Join Vizual</h3>
                <p className="text-gray-400 text-sm mb-6 leading-relaxed">
                  Unlock professional AI tools. <br /> Stop guessing, start creating.
                </p>

                <div className="space-y-3">
                  <button
                    onClick={handleGoogleLogin}
                    className="w-full flex items-center justify-center gap-3 py-3 rounded-lg border border-white/10 bg-white/5 text-white text-sm font-medium hover:bg-white/10 hover:border-white/20 transition-all backdrop-blur-sm group"
                  >
