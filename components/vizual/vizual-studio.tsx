      ...
      < section className="relative z-[100] w-full bg-black py-16 px-4 border-t border-white/5" >
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-wrap items-center justify-center gap-12 md:gap-20 animate-on-scroll animate-fade-in-up delay-200">
            <img src={`${CDN_BASE}/images/veo3-logo.svg`} alt="Veo 3" className="h-8 md:h-10 hover:scale-105 transition-transform" />
            <img src={`${CDN_BASE}/images/kling-logo-new.jpg`} alt="Kling AI" className="h-12 md:h-16 hover:scale-105 transition-transform" />
            <img src={`${CDN_BASE}/images/hailuo-ai-logo.svg`} alt="Hailuo AI" className="h-8 md:h-10 hover:scale-105 transition-transform" />
            <img src={`${CDN_BASE}/images/percify-logo.png`} alt="Percify" className="h-8 md:h-10 hover:scale-105 transition-transform" />
          </div>
        </div>
      </section >
