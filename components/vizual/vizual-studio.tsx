        ...
        {showInputModal && (
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-md bg-[#0a0a0a] rounded-3xl overflow-hidden shadow-2xl shadow-blue-900/20 border border-white/10"
            ...
            >
              ...
              <button
                onClick={() => setShowInputModal(false)}
                className="absolute top-4 right-4 z-20 w-8 h-8 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-md flex items-center justify-center transition-colors text-white"
              >
                <X className="w-4 h-4" />
              </button>
              ...
              <div className="relative z-10 p-8 flex flex-col items-center text-center">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center mb-6 shadow-lg shadow-blue-500/30">
                  <Sparkles className="w-6 h-6 text-white" />
                </div>

                <h3 className={`text-2xl font-bold mb-2 text-white ${spaceGrotesk.className}`}>
                  Welcome to Vizual
                </h3>
                <p className="text-gray-400 mb-8 max-w-xs mx-auto leading-relaxed">
                  Sign in to unlock professional AI video generation tools and bring your imagination to life.
                </p>

                {user ? (
                  <button
                    onClick={handleTryNow}
                    className="w-full py-3.5 rounded-xl bg-white text-black font-bold hover:bg-gray-100 transition-all hover:scale-[1.02]"
                  >
                    Enter Studio
                  </button>
                ) : (
                  <div className="w-full space-y-3">
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-3 py-3.5 rounded-xl bg-white text-black font-semibold hover:bg-gray-100 transition-all hover:scale-[1.02]"
                    >
                    ...
                    <button
                      onClick={handleTryNow}
                      className="w-full flex items-center justify-center gap-3 py-3.5 rounded-xl bg-white/5 border border-white/10 text-white font-semibold hover:bg-white/10 transition-all hover:scale-[1.02]"
                    >
