  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        ...
        { text: 'Unlimited images of select models', iconKey: 'image' },
        { text: '~5 mins Live feature / month', iconKey: 'video' },
        { text: '~3-5 short videos / month', iconKey: 'film' },
        { text: 'Access to all models', iconKey: 'settings' },
    ...
    },
    {
      ...
      features: [
        ...
        { text: 'Unlimited images', iconKey: 'image' },
        { text: '1 hr live streaming / month', iconKey: 'video' },
        { text: '10+ videos / month', iconKey: 'film' },
        { text: 'Access to all models', iconKey: 'sparkles' },
    ...
    },
    {
      ...
      features: [
        ...
        { text: '3 hrs live streaming / month', iconKey: 'video' },
        { text: '25+ videos / month', iconKey: 'film' },
